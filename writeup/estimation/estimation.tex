...
\begin{lem}
\[
E\left[\sum_{i=1}^{n}K_{h}\left(\|\bm{s}-\bm{s}_{i}\|\right)q_{1}\left(\left\{ \bm{Z}\left(\bm{s}_{i}\right)\right\} _{i}^{T}\bm{\zeta}\left(\bm{s}\right),Y\left(\bm{s}_{i}\right)\right)\left\{ \bm{Z}\left(\bm{s}_{i}\right)\right\} _{i}\right]\to(1/2)\alpha_{n}^{-1}h^{2}f\left(\bm{s}\right)\left(\begin{array}{ccc}
1 & \nu_{1} & \nu_{2}\\
\nu_{1} & \nu_{2} & \nu_{3}\\
\nu_{2} & \nu_{2} & \nu_{4}
...
\nu_{1} & \nu_{2} & \nu_{3}\\
\nu_{2} & \nu_{2} & \nu_{4}
\end{array}\right)\otimes\Gamma\left(\bm{s}\right)=-\Delta
\]
...
\[
H_{n}^{*}\left(\bm{u}\right)=A_{1}\left(\bm{s}\right)^{T}\bm{u}+(1/2)\bm{u}^{T}A_{2}\left(\bm{s}\right)\bm{u}+o_{p}\left(1\right)
\]
...
\begin{align}
\hat{\bm{u}}_{n}= & \left\{ A_{2}\left(\bm{s}\right)\right\} ^{-1}A_{1}\left(\bm{s}\right)\label{eq:limit-1}
\end{align}
