...
The values used for coefficients $\beta_1(\bm{s}), \dots, \beta_3(\bm{s})$ in simulation are plotted in Figure \ref{fig:simulation-coefficients}.
...
% Thu Sep 18 09:21:44 2014
  \multirow{6}{*}{100} & \multirow{2}{*}{0} & 0.5 & \textbf{1.42} & 1.46 & \textbf{0.40} & 0.43 & \textbf{0.04} & 0.10 & \textbf{0.04} & 0.09 \\ 
    &  & 1.0 & \textbf{1.67} & 1.91 & \textbf{0.46} & 0.55 & \textbf{0.32} & 0.40 & \textbf{0.13} & 0.21 \\ 
    & \multirow{2}{*}{0.5} & 0.5 & \textbf{1.76} & 1.82 & \textbf{0.26} & 0.33 & \textbf{0.09} & 0.14 & \textbf{0.30} & 0.51 \\ 
    &  & 1.0 & 1.34 & \textbf{1.30} & 0.42 & \textbf{0.31} & \textbf{0.04} & 0.07 & \textbf{0.20} & 0.45 \\ 
    & \multirow{2}{*}{0.9} & 0.5 & \textbf{2.35} & 3.62 & \textbf{0.91} & 2.73 & \textbf{1.20} & 2.20 & \textbf{1.50} & 2.27 \\ 
    &  & 1.0 & \textbf{1.91} & 2.71 & \textbf{0.67} & 1.31 & \textbf{0.22} & 0.65 & \textbf{0.62} & 1.89 \\ 
   \hline \multirow{6}{*}{200} & \multirow{2}{*}{0} & 0.5 & \textbf{1.31} & 1.33 & 0.18 & \textbf{0.17} & \textbf{0.15} & 0.24 & \textbf{0.03} & 0.07 \\ 
    &  & 1.0 & \textbf{1.25} & 1.25 & 0.43 & \textbf{0.32} & \textbf{0.04} & 0.09 & \textbf{0.05} & 0.19 \\ 
    & \multirow{2}{*}{0.5} & 0.5 & \textbf{1.44} & 1.56 & \textbf{0.19} & 0.19 & \textbf{0.07} & 0.15 & \textbf{0.03} & 0.10 \\ 
    &  & 1.0 & \textbf{1.23} & 1.34 & 0.37 & \textbf{0.34} & 0.04 & \textbf{0.04} & \textbf{0.03} & 0.12 \\ 
    & \multirow{2}{*}{0.9} & 0.5 & \textbf{2.18} & 2.53 & \textbf{0.72} & 1.15 & \textbf{0.58} & 0.90 & \textbf{0.61} & 0.78 \\ 
    &  & 1.0 & \textbf{2.09} & 2.22 & \textbf{0.65} & 1.31 & \textbf{0.11} & 0.38 & \textbf{0.11} & 0.63 \\ 
   \hline \multirow{6}{*}{400} & \multirow{2}{*}{0} & 0.5 & \textbf{1.22} & 1.23 & 0.18 & \textbf{0.17} & \textbf{0.06} & 0.08 & \textbf{0.03} & 0.05 \\ 
    &  & 1.0 & 1.15 & \textbf{1.12} & 0.18 & \textbf{0.18} & \textbf{0.05} & 0.07 & \textbf{0.02} & 0.06 \\ 
    & \multirow{2}{*}{0.5} & 0.5 & 1.26 & \textbf{1.26} & \textbf{0.19} & 0.24 & \textbf{0.05} & 0.08 & \textbf{0.01} & 0.09 \\ 
    &  & 1.0 & 1.20 & \textbf{1.20} & 0.33 & \textbf{0.29} & \textbf{0.05} & 0.08 & \textbf{0.02} & 0.07 \\ 
    & \multirow{2}{*}{0.9} & 0.5 & \textbf{1.54} & 1.62 & \textbf{0.37} & 0.41 & \textbf{0.36} & 0.54 & \textbf{0.41} & 0.61 \\ 
    &  & 1.0 & \textbf{1.41} & 1.70 & \textbf{0.46} & 0.71 & \textbf{0.14} & 0.34 & \textbf{0.02} & 0.23 \\
...
For all coefficients, the MISE was more often smaller under estimation by LAGR than under estimation by VCR.
The frequency with which MISE was lower under LAGR than under VCR for estimating $\beta_2$ was $11$ of $18$ cases, and was higher for all other coefficients.
...
% latex table generated in R 3.1.1 by xtable 1.7-3 package
% Thu Sep 18 09:21:44 2014
  \multirow{6}{*}{100} & \multirow{2}{*}{0} & 0.5 & 0.00 & 0.30 & 0.48 & 0.83 & 1.45 & \textbf{1.12} \\ 
    &  & 1.0 & 0.00 & 0.24 & 0.31 & 0.30 & 1.93 & \textbf{1.79} \\ 
    & \multirow{2}{*}{0.5} & 0.5 & 0.00 & 0.20 & 0.70 & 0.05 & 1.35 & \textbf{1.25} \\ 
    &  & 1.0 & 0.00 & 0.74 & 0.85 & 0.57 & 1.86 & \textbf{1.65} \\ 
    & \multirow{2}{*}{0.9} & 0.5 & 0.23 & 0.44 & 0.37 & 0.27 & 1.42 & \textbf{1.31} \\ 
    &  & 1.0 & 0.03 & 0.70 & 0.49 & 0.67 & 1.59 & \textbf{1.28} \\ 
   \hline \multirow{6}{*}{200} & \multirow{2}{*}{0} & 0.5 & 0.00 & 0.10 & 0.44 & 0.70 & 1.33 & \textbf{1.25} \\ 
    &  & 1.0 & 0.00 & 0.87 & 0.92 & 0.71 & 2.61 & \textbf{2.28} \\ 
    & \multirow{2}{*}{0.5} & 0.5 & 0.00 & 0.30 & 0.70 & 0.64 & 1.49 & \textbf{1.38} \\ 
    &  & 1.0 & 0.00 & 0.57 & 0.98 & 0.83 & 1.68 & \textbf{1.56} \\ 
    & \multirow{2}{*}{0.9} & 0.5 & 0.02 & 0.22 & 0.32 & 0.22 & 1.47 & \textbf{1.36} \\ 
    &  & 1.0 & 0.04 & 0.05 & 0.80 & 0.72 & 1.95 & \textbf{1.77} \\ 
   \hline \multirow{6}{*}{400} & \multirow{2}{*}{0} & 0.5 & 0.00 & 0.05 & 0.35 & 0.53 & 1.20 & \textbf{1.17} \\ 
    &  & 1.0 & 0.00 & 0.20 & 0.48 & 0.62 & 2.15 & \textbf{2.03} \\ 
    & \multirow{2}{*}{0.5} & 0.5 & 0.00 & 0.13 & 0.74 & 0.80 & 1.77 & \textbf{1.60} \\ 
    &  & 1.0 & 0.00 & 0.31 & 0.70 & 0.79 & 1.71 & \textbf{1.61} \\ 
    & \multirow{2}{*}{0.9} & 0.5 & 0.00 & 0.42 & 0.46 & 0.31 & 1.59 & \textbf{1.41} \\ 
    &  & 1.0 & 0.00 & 0.28 & 0.72 & 0.84 & 2.41 & \textbf{2.24} \\ 


  
	\hline
	\end{tabular}
	\caption{For each setting as a combination of sample size $n$, cross-covariate correlation $\rho$, and error standard deviation $\sigma_{\varepsilon}$, the frequency of exact zeroes in the estimates of $\hat{\beta}_1,\dots,\hat{\beta}_4$ as estimated by local adaptive grouped regularizaton (LAGR). Also, the mean integrated squared error (MISE) for the fitted output of each simulation setting, under variable selection via LAGR, and by locally linear regression without selection (VCR). \textbf{Highlighting} indicates the closest to the actual error variance $\sigma_\varepsilon^2$ for that simulation setting.}
	\label{tab:misey}
\end{table}
