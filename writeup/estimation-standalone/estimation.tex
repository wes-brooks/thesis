...
% Wed Sep 24 17:51:55 2014
  \multirow{6}{*}{100} & \multirow{2}{*}{0} & 0.5 & \textbf{1.43} & 1.46 & \textbf{0.41} & 0.43 & \textbf{0.04} & 0.10 & \textbf{0.05} & 0.09 \\ 
    &  & 1.0 & \textbf{1.41} & 1.47 & \textbf{0.44} & 0.55 & \textbf{0.04} & 0.17 & \textbf{0.03} & 0.13 \\ 
    & \multirow{2}{*}{0.5} & 0.5 & 1.47 & \textbf{1.42} & \textbf{0.43} & 0.48 & \textbf{0.04} & 0.16 & \textbf{0.05} & 0.13 \\ 
    &  & 1.0 & 1.48 & \textbf{1.43} & \textbf{0.49} & 0.59 & \textbf{0.05} & 0.24 & \textbf{0.03} & 0.19 \\ 
    & \multirow{2}{*}{0.9} & 0.5 & \textbf{1.91} & 2.16 & \textbf{0.76} & 1.33 & \textbf{0.08} & 0.73 & \textbf{0.00} & 0.59 \\ 
    &  & 1.0 & \textbf{1.95} & 2.97 & \textbf{1.08} & 1.78 & \textbf{0.14} & 1.08 & \textbf{0.06} & 0.83 \\ 
   \hline \multirow{6}{*}{200} & \multirow{2}{*}{0} & 0.5 & \textbf{1.32} & 1.33 & 0.18 & \textbf{0.17} & \textbf{0.15} & 0.24 & \textbf{0.04} & 0.07 \\ 
    &  & 1.0 & 1.38 & \textbf{1.35} & 0.22 & \textbf{0.19} & \textbf{0.09} & 0.26 & \textbf{0.05} & 0.12 \\ 
    & \multirow{2}{*}{0.5} & 0.5 & \textbf{1.41} & 1.48 & 0.21 & \textbf{0.19} & \textbf{0.29} & 0.43 & \textbf{0.06} & 0.12 \\ 
    &  & 1.0 & \textbf{1.51} & 1.57 & 0.26 & \textbf{0.25} & \textbf{0.27} & 0.43 & \textbf{0.08} & 0.19 \\ 
    & \multirow{2}{*}{0.9} & 0.5 & \textbf{1.64} & 2.02 & 0.52 & \textbf{0.51} & \textbf{0.85} & 1.80 & \textbf{0.13} & 0.49 \\ 
    &  & 1.0 & \textbf{1.79} & 2.40 & \textbf{0.65} & 0.77 & \textbf{0.92} & 1.80 & \textbf{0.31} & 0.82 \\ 
   \hline \multirow{6}{*}{400} & \multirow{2}{*}{0} & 0.5 & 1.23 & \textbf{1.23} & 0.18 & \textbf{0.17} & \textbf{0.06} & 0.08 & \textbf{0.04} & 0.05 \\ 
    &  & 1.0 & 1.28 & \textbf{1.27} & 0.21 & \textbf{0.19} & \textbf{0.07} & 0.09 & \textbf{0.06} & 0.10 \\ 
    & \multirow{2}{*}{0.5} & 0.5 & \textbf{1.25} & 1.27 & \textbf{0.21} & 0.22 & \textbf{0.07} & 0.13 & \textbf{0.04} & 0.08 \\ 
    &  & 1.0 & \textbf{1.26} & 1.31 & 0.27 & \textbf{0.26} & \textbf{0.08} & 0.15 & \textbf{0.07} & 0.15 \\ 
    & \multirow{2}{*}{0.9} & 0.5 & \textbf{1.43} & 1.47 & \textbf{0.38} & 0.56 & \textbf{0.16} & 0.54 & \textbf{0.07} & 0.38 \\ 
    &  & 1.0 & \textbf{1.40} & 1.49 & \textbf{0.57} & 0.77 & \textbf{0.20} & 0.67 & \textbf{0.22} & 0.71 \\ 
...
In no case was the MISE for LAGR more than $11\%$ greater than for VCR, while the MISE for estimating $\beta_4$ with $\rho=0.9$, $\sigma=0.5$, and $n=100$ setting was $140$ times greater for VCR than for LAGR.
That was the exception, though - under the other simulation settings, the greatest improvement for LAGR over VCR tended to fall between a $2--3$ times reduction in MISE.
...
With one exception, the frequency of exact zeros in the coefficient estimates increased uniformly as covariates grew less influential.
...
% latex table generated in R 3.1.1 by xtable 1.7-4 package
% Wed Sep 24 17:51:55 2014
  \multirow{6}{*}{100} & \multirow{2}{*}{0} & 0.5 & 0.00 & 0.30 & 0.54 & 0.86 \\ 
    &  & 1.0 & 0.00 & 0.47 & 0.62 & 0.93 \\ 
    & \multirow{2}{*}{0.5} & 0.5 & 0.00 & 0.50 & 0.74 & 0.92 \\ 
    &  & 1.0 & 0.00 & 0.56 & 0.74 & 0.89 \\ 
    & \multirow{2}{*}{0.9} & 0.5 & 0.01 & 0.59 & 0.79 & 0.96 \\ 
    &  & 1.0 & 0.01 & 0.53 & 0.72 & 0.78 \\ 
   \hline \multirow{6}{*}{200} & \multirow{2}{*}{0} & 0.5 & 0.00 & 0.12 & 0.48 & 0.76 \\ 
    &  & 1.0 & 0.00 & 0.32 & 0.68 & 0.84 \\ 
    & \multirow{2}{*}{0.5} & 0.5 & 0.00 & 0.16 & 0.44 & 0.65 \\ 
    &  & 1.0 & 0.00 & 0.29 & 0.63 & 0.69 \\ 
    & \multirow{2}{*}{0.9} & 0.5 & 0.00 & 0.50 & 0.64 & 0.71 \\ 
    &  & 1.0 & 0.00 & 0.43 & 0.62 & 0.63 \\ 
   \hline \multirow{6}{*}{400} & \multirow{2}{*}{0} & 0.5 & 0.00 & 0.05 & 0.41 & 0.57 \\ 
    &  & 1.0 & 0.00 & 0.18 & 0.42 & 0.61 \\ 
    & \multirow{2}{*}{0.5} & 0.5 & 0.00 & 0.18 & 0.48 & 0.71 \\ 
    &  & 1.0 & 0.00 & 0.30 & 0.57 & 0.74 \\ 
    & \multirow{2}{*}{0.9} & 0.5 & 0.00 & 0.59 & 0.64 & 0.74 \\ 
...
he estimates of the local coefficients are plotted in the first five panels of Figure \ref{fig:boston-lagr-coefs} and are summarized in Table \ref{tab:boston-coefs-lagr}.
The coefficients of CRIM, and LSTAT were everywhere estimated to be negative or exactly zero, meaning that the crime rate and proportion of ``lower-status" individuals were associated with a lower median house price. 
...
The coefficient of TAX was negative in most census tracts, but was estimated to be exactly zero in 50 tracts, meaning that in those tracts there was no discernable effect of the property tax rate on house prices.
...
The alternative that was considered was that the tracts with an estimated zero TAX coefficient were clustered among the tracts with a lower property tax rate.
...
This is compelling evidence that the property tax rate was more likely to have no apparent effect on the median house price in tracts where the property tax was lower.
